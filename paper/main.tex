...
\input{sections/03_exponent}
\input{sections/04_estimator}
\input{sections/05_kill}
\input{sections/06_insertion}
\input{sections/07_practical}
...
\texttt{artifacts/s08-final/phase4\_lambda.csv} and fitted curves from
\texttt{artifacts/s10-exponent-audit/phase1\_bootstrap.csv}. Right: both SPY venues
under traded-tick sampling, points from
\texttt{artifacts/s07-completion-and-spy/phase6\_spy\_grid\_\{ARCX,XNAS\}.csv}.
...
Read from \texttt{artifacts/s14-applications/phase1\_k8\_rates.csv} and
\texttt{artifacts/s09-application/phase3\_sizing\_params.csv}.}
\label{fig:mis}
\end{figure}
\clearpage
