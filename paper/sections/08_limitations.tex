...
misclassification in sample against $26.5$ percent out of sample, which inverts
...
$17.4$ percent of
windows carry a state-mean gap below $0.25$, against $6.9$ percent in the
holdout. Restricting attention to well-separated windows nonetheless moves the
two rates by only $0.67$ and $-0.04$ percentage points, about three percent of a
$21.95$ point inversion, and mean state separation is $1.709$ in sample against
$1.668$ out. Neither candidate accounts for the inversion, and we leave it
unexplained.
