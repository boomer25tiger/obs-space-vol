...
d=J("sessions/s09-application/results/phase12_summary.json")
add("K1/K2","reliability correction does not change MCS composition",
    ...
    "sessions/s09-application/results/phase12_summary.json","K2, excess_rth","before")
add("K2 (grid)","no reliability estimator is grid-invariant","FIRES",
    "lambda*Var(log RV) max/min ratio 1.05 best, 1.97 worst",
    "specs/SPEC-obs-space-vol-eval.md","section 7 null abstract","before")
d=J("sessions/s11-extensions/results/phase7_summary.json")
add("K3 (scaling)","proxy-error scaling inconsistent with sampling theory","STANDS",
    (f"reference inside the 95% interval in {sum(d['ref_inside_by_proxy'].values())} of {d['n_fits']} proxy fits"
     if d else "MISSING"),
    "sessions/s11-extensions/results/phase7_summary.json","ref_inside_by_proxy","before")
d=J("sessions/s09-application/results/phase7_k3.json")
add("K3 (sizing)","sizing consequence null",
    ...
    "sessions/s09-application/results/phase7_k3.json","extended.K3","before")
d=J("sessions/s12-correction/results/phase4_k4.json")
add("K4","risk-limit breaches",
    ...
    "sessions/s12-correction/results/phase4_k4.json","stop_out, leverage_cap","before")
d=J("sessions/s11-extensions/results/phase8910_summary.json")
add("K5","inverse-MSE combination weights",
    ...
    "sessions/s11-extensions/results/phase8910_summary.json","K5","before")
d=J("sessions/s12-correction/results/phase1_k6.json")
add("K6","variance-to-volatility convexity adjustment",
    ...
    "sessions/s12-correction/results/phase1_k6.json","K6","before")
d=J("sessions/s13-extension/results/phase2_k7.json")
add("K7","inverse-volatility risk parity",
    ...
    "sessions/s13-extension/results/phase2_k7.json","K7","before")
d=J("sessions/s14-applications/results/phase1_k8.json")
add("K8","regime misclassification at a median threshold",
    ...
    "sessions/s14-applications/results/phase1_k8.json","K8","after")
d=J("sessions/s15-confounds/results/s15_summary.json")
add("K9","HAR persistence attenuation","INDETERMINATE",
    ...
    "sessions/s15-confounds/results/s15_summary.json","K9","after")
add("K10","Hurst exponent bias from proxy noise",
    ...
    "sessions/s15-confounds/results/s15_summary.json","K10","after")
d=J("sessions/s16-regime/results/phase4_k11_final.json")
add("K11","regime classification under an observable-side correction",
    ...
    "sessions/s16-regime/results/phase4_k11_final.json","K11","after")
d=J("sessions/s17-emission/results/phase345_summary.json")
add("K12","measurement error in the emission",
    ...
    "sessions/s17-emission/results/phase345_summary.json","K12","after")
